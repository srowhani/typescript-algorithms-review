...
describe('traverse-bst', () => {
  ...
  describe('in-order', () => {
    ...
    it('[recursively] works', () => {
      const tree = new TraverseBSTT<string>({
        method: TraversalMethod.IN_ORDER
      });
      fillTree(tree);
    ...
    it('[iteratively] works', () => {
      const tree = new TraverseBSTT<string>({
        method: TraversalMethod.IN_ORDER_ITER
      });
      fillTree(tree);
  ...
  describe('post-order', () => {
    ...
    it('[recursively] works', () => {
      const tree = new TraverseBSTT<string>({
        method: TraversalMethod.POST_ORDER
      });
      fillTree(tree);
    ...
    it('[iteratively] works', () => {
      const tree = new TraverseBSTT<string>({
        method: TraversalMethod.POST_ORDER_ITER
      });
      fillTree(tree);
